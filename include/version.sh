...
Openssl_3_Ver='openssl-3.0.20'
Openssl_35_Ver='openssl-3.5.6'
Nghttp2_Ver='nghttp2-1.52.0'
Libzip_Ver='libzip-1.10.1'
...
Php_Ver_Short=$(echo "${Php_Ver}" | cut -d- -f2 | cut -d. -f1-2)
Php_Major_Ver=$(echo "${Php_Ver}" | cut -d- -f2 | cut -d. -f1)
