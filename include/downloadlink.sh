...
if [ "${Use_Official}" = "y" ]; then
 ...
 #  Luajit_DL="${Download_Mirror}/lib/lua/${Luajit_Ver}.tar.gz"
    ...
    Pcre2_DL="https://github.com/PCRE2Project/pcre2/releases/download/${Pcre2_Ver}/${Pcre2_Ver}.tar.bz2"
    ...
    Jemalloc_DL="https://github.com/jemalloc/jemalloc/releases/download/${Jemalloc_Ver_Short}/${Jemalloc_Ver}.tar.bz2"
    TCMalloc_DL="https://github.com/gperftools/gperftools/releases/download/${TCMalloc_Ver}/${TCMalloc_Ver}.tar.gz"
